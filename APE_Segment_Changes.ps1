...
write-output "$(get-date) : Changing the thread count from 1 to 2" | out-file $LOG_FILE -Append -Force;  
$file=Get-Content E:\EPS\globalsettings.xml
$file -replace 'threads="1" ','threads="2" ' | Out-File E:\EPS\globalsettings.xml
